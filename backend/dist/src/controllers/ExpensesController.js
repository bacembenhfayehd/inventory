...
const getExpensesByCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const expenses = yield prisma.expenseByCategory.findMany({
            orderBy: {
                date: "desc",
            },
        });
        const expensesCategory = expenses.map((item) => (Object.assign(Object.assign({}, item), { amount: item.amount.toString() })));
