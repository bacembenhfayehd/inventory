...
const getDashboardMetrics = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const expenseByCategorySummary = expenseByCategorySummaryRaw.map((item) => (Object.assign(Object.assign({}, item), { amount: (item === null || item === void 0 ? void 0 : item.amount.toString()) || "0" })));
        res.json({
            popularProducts,
            purchaseSummary,
            salesSummary,
